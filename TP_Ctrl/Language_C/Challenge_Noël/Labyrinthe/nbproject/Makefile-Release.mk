...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/labyrinthe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/labyrinthe ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/lib/bdf-font.o: lib/bdf-font.cc
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/bdf-font.o lib/bdf-font.cc

${OBJECTDIR}/lib/content-streamer.o: lib/content-streamer.cc
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/content-streamer.o lib/content-streamer.cc

${OBJECTDIR}/lib/framebuffer.o: lib/framebuffer.cc
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/framebuffer.o lib/framebuffer.cc

${OBJECTDIR}/lib/gpio.o: lib/gpio.cc
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/gpio.o lib/gpio.cc

${OBJECTDIR}/lib/graphics.o: lib/graphics.cc
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/graphics.o lib/graphics.cc

${OBJECTDIR}/lib/hardware-mapping.o: lib/hardware-mapping.c
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/hardware-mapping.o lib/hardware-mapping.c

${OBJECTDIR}/lib/led-matrix-c.o: lib/led-matrix-c.cc
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/led-matrix-c.o lib/led-matrix-c.cc

${OBJECTDIR}/lib/led-matrix.o: lib/led-matrix.cc
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/led-matrix.o lib/led-matrix.cc

${OBJECTDIR}/lib/multiplex-mappers.o: lib/multiplex-mappers.cc
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/multiplex-mappers.o lib/multiplex-mappers.cc

${OBJECTDIR}/lib/options-initialize.o: lib/options-initialize.cc
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/options-initialize.o lib/options-initialize.cc

${OBJECTDIR}/lib/pixel-mapper.o: lib/pixel-mapper.cc
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/pixel-mapper.o lib/pixel-mapper.cc

${OBJECTDIR}/lib/thread.o: lib/thread.cc
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/thread.o lib/thread.cc

${OBJECTDIR}/lib/transformer.o: lib/transformer.cc
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/transformer.o lib/transformer.cc
